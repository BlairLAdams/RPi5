### **Transitioning from Founders to Framework**

Hazen’s Utility Management Services (UMS) division has emerged from a coalition of subject matter experts delivering value across specialized areas: AI, BI, GIS, CMMS, SCADA, LIMS, WIMS, BIM, Asset Management, Digital Twins, No Code / Low Code Solutions, and Custom Software. This founding team has driven impactful outcomes through domain-specific leadership and technical depth, often in a bootstrapped, entrepreneurial mode.

As demand grows for integrated digital services and scalable delivery models, UMS now faces a pivotal transition. The absence of a shared vision and structured framework has limited the division’s ability to scale consistently, resulting in duplicated efforts, unclear engagement models, and internal ambiguity. Without defined leadership, best practice design patterns, or a roadmap toward maturity (e.g., [CMMi Level 3+](https://en.wikipedia.org/wiki/Capability_Maturity_Model_Integration)), opportunities are often reactive rather than strategic and staff attrition has begun to reflect the strain of this ambiguity.
...
1. **Stantec**  
    Provides digital solutions encompassing smart water technologies, GIS integration, and digital twin applications for water infrastructure.  
2. **AECOM**  
    Offers comprehensive digital services, including data analytics, asset management, and smart infrastructure solutions tailored for water utilities.  
3. **Carollo Engineers**  
    Specializes in water-focused engineering with digital offerings such as advanced modeling, SCADA integration, and data-driven decision support tools.  
4. **CDM Smith**  
    Delivers digital transformation services, including intelligent water systems, real-time monitoring, and predictive analytics for utility management.  
5. **HDR**  
    Engages in digital project delivery, integrating BIM, GIS, and data analytics to enhance water and wastewater infrastructure projects.  
6. **Tetra Tech**  
    Provides digital solutions focusing on data management, predictive modeling, and smart utility operations for water sector clients.  
7. **Black & Veatch**  
    Offers digital water services, including IoT integration, data analytics, and digital twin technologies to optimize utility performance.  
8. **Arcadis**  
    Delivers digital transformation in water management through smart asset management, data analytics, and digital platform development.  
9. **Brown and Caldwell**  
    Focuses on digital solutions for water and environmental sectors, including data integration, analytics, and smart infrastructure design.  
10. **Woodard & Curran**  
     Provides integrated digital services, encompassing data management, GIS applications, and operational optimization for water utilities.
...
### **1\. Market Context and Emerging Need**
...
**Brown and Caldwell, Woodard & Curran**
...
### **3\. Hazen’s Unique Advantage as a Professional Services Firm**
...
* We emphasize trust, not tech demos.
  ...
  #### **1\. Codify Our Approach into a Branded Framework**
...
* Use case mapping to regulatory, O\&M, planning, and compliance decisions
  ...
  #### **2\. Develop Short-Format Offer Sheets for Pilot Clients**
...
* “Capital Planning Optimizer” – expose buried Excel logic in a defensible BI tool
  ...
  #### **3\. Invest in a Cross-Functional Ecosystem Team**
...
#### **4\. Create a “Data Readiness Assessment” Tool**
...
### **Conclusion: Re-Architecting Teams for Adaptive Delivery**
